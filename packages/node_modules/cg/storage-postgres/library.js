...
module.exports = {
    ...
    reload: function(){
       return runtimestorage.getAllData("cg:library:").then(function(result){
        result.forEach(element => {
          _this.saveLibraryEntry(element.data.type, element.data.path,element.data.meta, element.data.body);
        });
    ...
    saveLibraryEntry: function(type,path,meta,body) {
        ...
        return fs.ensureDir(fspath.dirname(fn)).then(function () {
          ...
          runtimestorage.saveJson(key, {meta: meta, body: body, type : type, path : path}).then(function(result){
