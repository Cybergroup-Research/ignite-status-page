...
function saveProjectDetailsInDB() {
    ...
    var isSavingEnabled = currentdate > interval;

    if (!interval || isSavingEnabled) {
        interval = new Date(currentdate.getTime() + 1000 * 3);
        if (settings && settings.isApplicationLoaded && settings.isProjectTblPresent) {
