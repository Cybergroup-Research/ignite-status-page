...
var auth = require('../../editor-api/lib/auth/index');
...
function init(userSettings,httpServer,_adminApi,__util) {
    ...
    userSettings.storagePersistence = storage;
    settings.init(userSettings);

    nodeApp = express();
    adminApp = express();

    nodeApp.use("/runtimeDetails", auth.needsPermission(), externalAPI.runtimeDetails.app);
